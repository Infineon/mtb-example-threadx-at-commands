...
APPNAME=mtb-example-threadx-at-commands
...
DEFINES+=CY_RTOS_AWARE NX_SECURE_ALLOW_SELF_SIGNED_CERTIFICATES CY_RETARGET_IO_CONVERT_LF_TO_CRLF
DEFINES+= CY_WIFI_COUNTRY=WHD_COUNTRY_UNITED_STATES

DEFINES += TX_PACKET_POOL_SIZE=12
DEFINES += RX_PACKET_POOL_SIZE=22
DEFINES += WCM_WORKER_THREAD_STACK_SIZE=5120
DEFINES += SECURE_SOCKETS_THREAD_STACKSIZE=4096
HEAP_SIZE=0x16000
